...
public:
	CMainParams() {
		...
		const char* pszTimestamp = "Kendrick Lamar wins Pulitzer Prize";
		...
		vout.resize(1);
		vout[0].SetEmpty();
		CTransaction txNew(1, 1524000091, vin, vout, 0);
		genesis.vtx.push_back(txNew);
		genesis.hashPrevBlock = 0;
		genesis.hashMerkleRoot = genesis.BuildMerkleTree();
		genesis.nVersion = 1;
		genesis.nTime = 1524000091;
		...
		vSeeds.push_back(CDNSSeedData("0", "syncnode-1.turbogoldproject.ml"));
